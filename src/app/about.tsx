...
import { faClockRotateLeft, faFileZipper } from '@fortawesome/free-solid-svg-icons'
...
export default function About() {
  ...
  return (
    <section className="flex-row items-center text-center text-white mt-5">
      ...
      <a href="https://zipmyfile.com/"><FontAwesomeIcon icon={faFileZipper}/> ZipMyFile.com</a>
    </section>
  )
}
